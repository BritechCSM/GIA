...
function ReportCard({ report }: { report: Report }) {
  return (
    <Card className="rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.02)] border-slate-100 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all bg-white overflow-hidden">
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.02)] border-slate-100 bg-white overflow-hidden">
